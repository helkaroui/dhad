...
function Environment(parent) {
    this.vars = Object.create(parent ? parent.vars : std_lib);
    this.parent = parent;
}
...
globalEnv.def("اكتب", function(val){
    if(consoleBlock.innerHTML != "") consoleBlock.innerHTML+="<br>";
    consoleBlock.innerHTML+=val;
});
